package com.maxy.caller.common.utils.timewheel;
...
public class HashedWheelTimer implements Timer {
    ...
    private final ThreadPoolExecutor taskProcessPool;
    ...
    public HashedWheelTimer(long tickDuration, int ticksPerWheel, int processThreadNum) {
        ...
        if (processThreadNum <= 0) {
            ...
            taskProcessPool = new ThreadPoolExecutor(core, 2 * core,
                    60, TimeUnit.SECONDS,
                    queue, threadFactory, RejectedExecutionHandlerFactory.newCallerRun("CallerTimeWheelPool"));
            //初始化
            taskProcessPool.prestartAllCoreThreads();
        }
